...
import com.example.yo.twittfollows.tabs.FansTab;
import com.example.yo.twittfollows.tabs.FollowersTab;
import com.example.yo.twittfollows.tabs.MutualsTab;
import com.example.yo.twittfollows.tabs.RecentUnfollowersTab;
import com.example.yo.twittfollows.tabs.UnfollowersTab;
...
public class CentralActivity extends AppCompatActivity {
    ...
    private class AsyncCaller extends AsyncTask<Void, Void, Integer> {
        ProgressDialog pdLoading =
                new ProgressDialog(CentralActivity.this, R.style.AppCompatAlertDialogStyle);
